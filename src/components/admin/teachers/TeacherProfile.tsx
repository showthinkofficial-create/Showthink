    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-gray-200">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={onEdit}
            className="px-4 py-2 bg-amber-50 hover:bg-amber-100 text-amber-900 border border-amber-300 rounded-xl text-xs font-extrabold transition-colors cursor-pointer flex items-center gap-1.5"
          >
          ...
          {isActive && (
            <button
              onClick={onDisable}
              className="px-4 py-2 bg-rose-50 hover:bg-rose-100 text-rose-800 border border-rose-200 rounded-xl text-xs font-extrabold transition-colors cursor-pointer flex items-center gap-1.5"
            >
              <UserX className="w-3.5 h-3.5 text-rose-600" />
              <span>Disable Teacher</span>
            </button>
          )}
        </div>
      </div>
